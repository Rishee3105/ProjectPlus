...
//   try { 
//     // console.log("Fetching project details for:", req.query);
...
//       where:{
//         charusatId:project.members.charusatId
//       }
//     })

//     // console.log(project)
//     // console.log("User Data:", userData.charusatId);
...
const getParticularProjectDetails = async (req, res) => {
  try {
    ...
    // Optional debug log: safely access user info
...
const getParticularUserRequestStatus = async (req, res) => {
  try {
    ...
    const requestStatus = await prisma.prequest.findFirst({
      where: {
